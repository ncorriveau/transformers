    ...
    for (int row = 0; row < m; row++) {
        for (int col = 0; col < n; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 32; qj+=4) {
                    // TODO: decode a packed byte into two int8 in the range of (-8, 7)
                    uint8_t packed_int4_0 = w_int4[qj];
                    uint8_t packed_int4_1 = w_int4[qj + 1];
                    uint8_t packed_int4_2 = w_int4[qj + 2];
                    uint8_t packed_int4_3 = w_int4[qj + 3];
                    ...
                    intermediate_sum1 += a_int8[(qj+1)] * w_de_0_1;
                    intermediate_sum1_2nd += a_int8[(qj+1) + 32] * w_de_16_1;
                    intermediate_sum2 += a_int8[(qj+2)] * w_de_0_2;
                    intermediate_sum2_2nd += a_int8[(qj+2) + 32] * w_de_16_2;
                    intermediate_sum3 += a_int8[(qj+3)] * w_de_0_3;
                    intermediate_sum3_2nd += a_int8[(qj+3) + 32] * w_de_16_3;
